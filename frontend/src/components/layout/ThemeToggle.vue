...
<template>
  <button @click="theme.toggleTheme()" class="theme-toggle" aria-label="切换主题">
    <!-- Sun icon (show in dark mode = click to go light) -->
    <svg v-if="theme.currentTheme === 'dark'" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
